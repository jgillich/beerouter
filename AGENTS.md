...
## Overview
Beerouter is a routing engine for OpenStreetMap data, originally forked from BRouter. It provides efficient routing capabilities with support for custom profiles and advanced features like nogo areas and turn restrictions.
...
- **Always use the extension methods from `core/src/main/java/dev/skynomads/beerouter/osm/coordinates.kt` for coordinate conversions**
- These extension methods provide accurate and consistent conversions between integer and double coordinates
